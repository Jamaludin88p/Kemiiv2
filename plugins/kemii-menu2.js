...
await conn.sendMessage(m.chat, { audio: { url: './mp3/kemii.mp3' }, viewOnce: true, seconds: fsizedoc, ptt: true, mimetype: "audio/mpeg", fileName: "vn.mp3", waveform: [100,0,100,0,100,0,100] }, { quoted: m })
